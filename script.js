const openRule = document.getElementById("rule_button")   // Rules button
const cloaseRule = document.getElementById("close_rule")  // Close Button
const gameRule = document.getElementById("game_rule")     // Game Rule 
const nextBtn = document.getElementById("next");      // Rules button 
...
// when the user click on any of the rock paper scissor function execute 
